...
class TestFormatExpressionStringNegativeNumbers:
    ...
    def test_simple_negative_number_no_english(self):
        ...
        result = format_expression_string(
            expression, initial_values, english_conversion_probability=0.0, seed=42
        )
    ...
    def test_simple_negative_number_full_english(self):
        ...
        initial_values = [-5.2]
        result = format_expression_string(
            expression, initial_values, english_conversion_probability=1.0, seed=42
        )
    ...
    def test_very_small_negative_number(self):
        ...
        english_name = convert_number_to_english(-0.001, max_decimal_places=6)
        expression = sympy.Symbol(english_name)
    ...
    def test_partial_english_conversion_deterministic(self):
        ...
        result1 = format_expression_string(
            expression, initial_values, english_conversion_probability=0.5, seed=42
        )
    ...
    def test_partial_english_conversion_different_seeds(self):
        ...
        result2 = format_expression_string(
            expression, initial_values, english_conversion_probability=1.0, seed=123
        )
    ...
    def test_decimal_places_limit_negative(self):
        ...
        english_name = convert_number_to_english(-3.123456789, max_decimal_places=3)
        expression = sympy.Symbol(english_name)
